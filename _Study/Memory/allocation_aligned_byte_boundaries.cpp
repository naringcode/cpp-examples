...
int main()
{
    ...
    // 0x0000000000000001 ~ 0x000000000000000F : 16바이트 경계를 맞춰서 할당할 경우 중간 주소(주소의 뒷자리가 0임)
    // 0x0000000000000001 ~ 0x0000000000000007 : 8바이트 경계를 맞춰서 할당할 경우 중간 주소(주소의 뒷자리가 0인 경우)
    // 0x0000000000000009 ~ 0x000000000000000F : 8바이트 경계를 맞춰서 할당할 경우 중간 주소(주소의 뒷자리가 8인 경우)
    //
